...
const Footer: React.FC<{
    ...
    setAudioEnabled: enableFunc}> = ({videoEnabled, audioEnabled, setVideoEnabled, setAudioEnabled}) => {
    return (
        <div className={"footer-container"}>
            <Tooltip title="Camera">
                <IconButton aria-label="camera" onClick={() => setVideoEnabled(!videoEnabled)}>
                    { videoEnabled ?  <VideocamOutlinedIcon  /> : <VideocamOffOutlinedIcon/> }
                </IconButton>
            </Tooltip>
            
            <Tooltip title="Microphone">
                <IconButton aria-label="mic" onClick={() => setAudioEnabled(!audioEnabled)}>
